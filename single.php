...
while ($my_query->have_posts()) : $my_query->the_post(); ?>
              <div class="related-posts-single">
                <div class="zoom">
                  <a href="">
                    <img src="<?php the_post_thumbnail_url( ); ?>" alt="blog-details-5">
                  </a>
                  <h5>
                    <a href="">
                      <?php the_title(); ?>
...
?>                                
          ...
          <div id="respond">
            ...
            <p>You must be 
              <a href="<?php echo wp_login_url( get_permalink() ); ?>">logged in
              </a> to post a comment.
            </p>
            <?php else : ?>
            <form action="<?php echo get_option('siteurl'); ?>/wp-comments-post.php" method="post" id="commentform">
              ...
              <p>Logged in as 
                ...
                <a href="<?php echo wp_logout_url( get_permalink() ); ?>" title="Log out of this account">Log out &raquo;
                </a>
              </p>
              ...
              <?php endif; ?>
              <p>
                <input name="submit" type="submit" class="submit theme-btn  wow fadeInUp" id="submit" tabindex="5" value="Submit" />
              </p>
      ...
      <div class="col-lg-4">
        <div class="sidebar-right">
          <div class="popular-post">
            <h4 class=" wow fadeInUp">Most Popular
            </h4>
